...
<section class="dataset-page">
    ...
    <div class="header-container">
        ...
        <div class="dropdown">
            ...
            <div class="dropdown-content">
                <a href="?controller=service&page=1&sort=trending">Trending</a>
                <a href="?controller=service&page=1&sort=price_asc">Price: Low to High</a>
                <a href="?controller=service&page=1&sort=price_desc">Price: High to Low</a>
                <a href="?controller=service&page=1&sort=name_asc">Name: A to Z</a>
                <a href="?controller=service&page=1&sort=name_desc">Name: Z to A</a>
            </div>
        </div>
    </div>
    ...
    <ul class="pagination" id="pagination-container">
        <li class="<?= ($currentPage == 1) ? 'disabled' : '' ?>">
            <a href="?controller=service&page=<?= max(1, $currentPage - 1) ?>&sort=<?= $sort ?>">«</a>
        </li>

        <?php for ($i = 1; $i <= $totalPages; $i++): ?>
            <li class="<?= ($i == $currentPage) ? 'active' : '' ?>">
                <a href="?controller=service&page=<?= $i ?>&sort=<?= $sort ?>"><?= $i ?></a>
            </li>
        <?php endfor; ?>

        <li class="<?= ($currentPage == $totalPages) ? 'disabled' : '' ?>">
            <a href="?controller=service&page=<?= min($totalPages, $currentPage + 1) ?>&sort=<?= $sort ?>">»</a>
        </li>
    </ul>
